...
class _CALLER_PACKAGE(object):
    def __repr__(self): # pragma: no cover (for docs)
        return 'batteries.path.CALLER_PACKAGE'
...
class AssetResolver(Resolver):
    ...
    - The constant value :attr:`batteries.path.CALLER_PACKAGE`.

    The default value is :attr:`batteries.path.CALLER_PACKAGE`.

    The ``package`` is used when a relative asset specification is supplied
    to the :meth:`~batteries.path.AssetResolver.resolve` method.  An asset
    ...
    If the value :attr:`batteries.path.CALLER_PACKAGE` is supplied as the
    ``package``, the resolver will treat relative asset specifications as
    relative to the caller of the :meth:`~batteries.path.AssetResolver.resolve`
    method.
    ...
    :meth:`~batteries.path.AssetResolver.resolve` method, the resulting absolute
    ...
    to the :meth:`~batteries.path.AssetResolver.resolve` method, the resulting
    ...
    def resolve(self, spec):
        ...
        :class:`batteries.interfaces.IAssetDescriptor`.
...
class DottedNameResolver(Resolver):
    ...
    :meth:`~batteries.path.DottedNameResolver.resolve` method.  A dotted name
    ...
    the caller of the :meth:`~batteries.path.DottedNameResolver.resolve`
    method.
    ...
    :meth:`~batteries.path.DottedNameResolver.resolve` method, the resulting
    ...
    def maybe_resolve(self, dotted):
        ...
        :meth:`~batteries.path.DottedNameResolver.resolve`, except if the
